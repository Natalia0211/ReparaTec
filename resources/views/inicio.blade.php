...
@section('cabecera', 'ReparaTec - Contamos con el mejor servicio de Soporte Tecnico')
...
@section('contenido')
    <div class="hero min-h-screen" style="background-image: url(https://source.unsplash.com/random/400x200/?market);">
        ...
        <div class="max-w-md">
            <h1 class="mb-5 text-5xl font-bold">Aquí encontrará los mejores repuestos y accesorios para sus dispositivos moviles!</h1>
